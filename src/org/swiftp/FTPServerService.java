...
//	protected static InetAddress serverAddress = null;
	...
	private boolean loadSettings(Intent i) {
		...
		String username = settings.getFtpUserName();
		String password = settings.getFtpPassword();
		//String chrootDir = i.getExtras().getString("rootdir");
		String chrootDir = settings.getSharingDir();
		if(chrootDir == null) {
			chrootDir = Environment.getExternalStorageDirectory().getPath();
		}
