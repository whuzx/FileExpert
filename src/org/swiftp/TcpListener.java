...
public class TcpListener extends Thread {
	...
	public TcpListener(ServerSocket listenSocket, FTPServerService ftpServerService) {
		...
		mSettings = new FileExpertSettings(this.ftpServerService);
	}
		...
		try {
			while(true) {
				...
				SessionThread newSession = new SessionThread(clientSocket,
						...
						SessionThread.Source.LOCAL, mSettings.getFtpEncoding());
				newSession.setEncoding(mSettings.getFtpEncoding());
				newSession.start();
